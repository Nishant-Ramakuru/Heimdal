...
library("igraph")
anuser<-function(uname,numtw = 50){
anunm<-paste("from:",uname,sep="")  
ts<-CollectDataTwitter(anunm,numTweets = numtw)
ats<<-ts
}
#Actor network , no extra paramaters
actor<-function(remv = 4){
...
semantic<-function(tf=20,htf=80,remv=4){
